// WITH BOUNCING EFFECTS  (WITHOUT COUNTINOUS ROTATION)
'use client';
...
interface ModelWithBouncingEffectsProps {
  selectedProduct: ProductType;
}

const ModelWithBouncingEffects = ({ selectedProduct }: ModelWithBouncingEffectsProps) => {
...
export default ModelWithBouncingEffects;
