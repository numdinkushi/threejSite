// ON MOUSE DOWN AND UP EVENT (TO BRING IT BACK TO DEFAULT OUTSIDE BUT CAN ROTATE BY CLIKING AND HOLDING DONW)
...
interface ModelWithOnMouseDownProps {
  selectedProduct: ProductType;
}

const ModelWithOnMouseDown = ({ selectedProduct }: ModelWithOnMouseDownProps) => {
...
export default ModelWithOnMouseDown;