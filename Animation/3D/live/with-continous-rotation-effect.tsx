// MODEL WITH CONTINOUS ANIMATION
...
interface ModelWithContinousAnimationProps {
  selectedProduct: ProductType;
}

const ModelWithContinousAnimation = ({ selectedProduct }: ModelWithContinousAnimationProps) => {
...
export default ModelWithContinousAnimation;
