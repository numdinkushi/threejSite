//ON MOUSE DOWN AND UP EVENT WITH RESPONSIVENESS
...
interface ModelWithOnMouseEventAndResponsivenessProps {
  selectedProduct: ProductType;
}

const ModelWithOnMouseEventAndResponsiveness = ({ selectedProduct }: ModelWithOnMouseEventAndResponsivenessProps) => {
...
export default ModelWithOnMouseEventAndResponsiveness;