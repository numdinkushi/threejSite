// CONTINOUS ROTATION WITH BOUNCING EFFECTS
...
interface ModelWithContinousRotationAndBouncingEffectsProps {
  selectedProduct: ProductType;
}

const ModelWithContinousRotationAndBouncingEffects = ({ selectedProduct }: ModelWithContinousRotationAndBouncingEffectsProps) => {
...
export default ModelWithContinousRotationAndBouncingEffects;
